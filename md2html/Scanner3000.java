...
public class Scanner3000 implements AutoCloseable {
	...
	public Scanner3000(String source) throws IOException {
		reader = new StringReader(source);
	}

	public Scanner3000(FileInputStream source) throws IOException {
        reader = new InputStreamReader(source, "utf8");
    }
