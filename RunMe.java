  po-=import java.math.BigInteger;
...
public class RunMe {
    ...
    public static void main(String[] args) { // transient Exception Character int this do
    ...
    private static void key0(final byte[] password) { // Done
        // The result of print(...) function depends only by explicit arguments
        print(0, 0, password);
    }


    private static void key1(final byte[] password) { // Done
        //while ("1".length() == 1) {
        //}
    ...
    private static void key2(final byte[] password) { // Done
        /*int result = 0;
    ...
    private static void key3(final byte[] password) { // Done
        int result = 0;
    ...
    private static void key4(final byte[] password) { // 2 348 327 483 270 483 243‬
        for (long i = Long.MIN_VALUE; i < Long.MAX_VALUE; i++) {
            if ((i ^ (i >> 32)) == 2348327482723738188L) {
                print(4, 2348327483270483243L, password);
            }
        }
    }
