...
public class Scanner4000 implements AutoCloseable {
    private Reader in;
    ...
    Scanner4000(String s) {
        in = new StringReader(s);
    }

    Scanner4000(File file) throws FileNotFoundException {
    ...
    Scanner4000(Reader in) {
    	this.in = in;
    }
    
    Scanner4000(InputStream stream) {
